...
<body>
    ...
    <div id="editModal7"> <!-- Cambiado a editModal3 -->
        <div class="modal-content">
            ...
            <h2>Editar Guion</h2>
            <textarea id="editText7" rows="4" style="width: 100%;"></textarea> <!-- Cambiado a editText3 -->
            <button id="saveChanges7" onclick="saveParagraph()">Guardar</button> <!-- Cambiado a saveChanges3  -->
        </div>
    </div>
...
/* */       const textElement = document.getElementById('para7' + paraId).getElementsByTagName('p')[0]; 
 ...
 /* */      const updatedText = document.getElementById('editText7').value; 
 /* */      const textElement = document.getElementById('para7' + currentParaId).getElementsByTagName('p')[0]; 
            textElement.innerText = updatedText; 

            // Envía la nueva información al servidor
/* */       fetch('update_pagina7.php', { 
                method: 'POST',
                headers: {
