    ...
    ?>
		...
		<div id="editModal4"> <!-- Cambiado a editModal3 -->
			<div class="modal-content">
				...
				<textarea id="editText4" rows="4" style="width: 100%;"></textarea> <!-- Cambiado a editText3 -->
				<button id="saveChanges4" onclick="saveParagraph()">Guardar</button> <!-- Cambiado a saveChanges3  -->
			</div>
		</div>
